 ...
 * const { PaymentBuilder } = require('../patterns/builder/ParkingQueryBuilder');
 *
 * const payment = new PaymentBuilder()
 *   .setAmount(50)
 *   .setMethod("card")
 *   .setDescription("Reservation parking")
 *   .setStatus("pending")
 *   .build();
 *
 * // payment = { amount: 50, method: "card", description: "Reservation parking", status: "pending", createdAt: ... }
 */
